...
<body>
  <header>
    ...
    <div class="header-text">
      <h1>${title}</h1>
      <p>مرسول — توصيل سريع في دمشق</p>
    </div>
  </header>
  <main>${body}</main>
  <footer>© 2025 مرسول. جميع الحقوق محفوظة.</footer>
</body>
</html>`;
...
<div class="section">
  ...
  <p>نجمع المعلومات التي تزودنا بها عند التسجيل مثل رقم هاتفك واسمك. كما نجمع بيانات الاستخدام كالطلبات والعناوين وتاريخ المعاملات.</p>
</div>
<div class="section">
...
<div class="section">
  <h2>١. قبول الشروط</h2>
  <p>باستخدامك لتطبيق مرسول، فأنت توافق على الالتزام بهذه الشروط. إذا كنت لا توافق على أي جزء منها، يرجى عدم استخدام التطبيق.</p>
</div>
<div class="section">
  <h2>٢. وصف الخدمة</h2>
  <p>مرسول منصة وساطة تربط بين العملاء والمندوبين في دمشق وريفها. نحن لسنا طرفاً في عملية التوصيل بل نوفر الوسيلة التقنية لإتمامها.</p>
</div>
<div class="section">
...
<div class="section">
  ...
  <p>لا تتحمل مرسول مسؤولية التأخير الناجم عن ظروف خارجة عن إرادتها كحوادث السير أو ظروف الطقس القاهرة.</p>
</div>
<div class="section">
